    ...
    sports: [
      {
        ...
        description:
          "Традиционный вид спорта Кыргызстана с богатой историей побед. Обучение вольной и греко-римской борьбе.",
        programs: [
          "Классическая база",
          "Тактика ведения боя",
      ...
      },
      {
        ...
        description:
          "Королева спорта. Комплексная подготовка спринтеров, стайеров и прыгунов для международных соревнований.",
      ...
      },
      {
        ...
        type: "ЕДИНОБОРСТВА",
        image:
          "https://images.unsplash.com/photo-1555597673-b21d5c935865?q=80&w=1080&auto=format&fit=crop",
        description:
          "Олимпийское дзюдо. Фокус на технике бросков, борьбе в партере и психологической устойчивости.",
      ...
      },
      {
        ...
        type: "ЕДИНОБОРСТВА",
        image:
          "https://images.unsplash.com/photo-1724529808495-8b7cf64e3e3a?q=80&w=1080&auto=format&fit=crop",
        description:
          "Олимпийский бокс. Развитие скорости, точности ударов и тактического мышления на ринге.",
        programs: [
          "Постановка удара",
          "Защитные действия",
          "Спарринг-практика",
      ...
      },
      {
        ...
        description:
          "Подготовка юношеских и молодежных сборных U-17, U-19, U-21 по передовым методикам.",
        programs: [
      ...
      },
      {
        ...
        type: "ВОДНЫЕ ВИДЫ",
        image:
          "https://images.unsplash.com/photo-1572594505398-97a384b34ec8?q=80&w=1080&auto=format&fit=crop",
        description:
          "Спортивное плавание. Совершенствование техники во всех стилях и развитие скоростной выносливости.",
      ...
      items: [
        {
          num: "01",
          title: "ВОЗРАСТ",
          desc: "От 12 до 23 лет в зависимости от специфики вида спорта.",
        },
        {
          num: "02",
          title: "ЗДОРОВЬЕ",
          desc: "Полное медицинское обследование и допуск спортивного диспансера.",
        },
        {
          num: "03",
          title: "БАЗА",
          desc: "Наличие спортивного разряда или подтвержденные результаты.",
        },
        {
          num: "04",
          title: "ГРАФИК",
          desc: "Готовность к двухразовым тренировкам 6 дней в неделю.",
        },
      ],
    },
  },
    ...
    sports: [
      {
        ...
        image:
          "https://images.unsplash.com/photo-1576149146095-caa19d4de102?q=80&w=1080&auto=format&fit=crop",
        description:
          "Кыргызстандын бай жеңиш тарыхы бар салттуу спорт түрү. Эркин жана грек-рим күрөшүнө окутуу.",
      ...
      },
      {
        ...
        image:
          "https://images.unsplash.com/photo-1765261473063-ec862e10ba58?q=80&w=1080&auto=format&fit=crop",
        description:
          "Спорт канышасы. Эл аралык мелдештер үчүн спринтерлерди, стайерлерди жана секирүүчүлөрдү комплекстүү даярдоо.",
      ...
      },
      {
        ...
        image:
          "https://images.unsplash.com/photo-1555597673-b21d5c935865?q=80&w=1080&auto=format&fit=crop",
        description:
          "Олимпиадалык дзюдо. Ыргытуу техникасына, партердеги күрөшкө жана психологиялык туруктуулукка басым жасоо.",
        programs: [
          "Ыргытуу техникасы",
          "Партердеги күрөш",
          "Көзөмөл жана кармоо",
      ...
      },
      {
        ...
        image:
          "https://images.unsplash.com/photo-1724529808495-8b7cf64e3e3a?q=80&w=1080&auto=format&fit=crop",
        description:
          "Олимпиадалык бокс. Рингде ылдамдыкты, соккулардын тактыгын жана тактикалык ой жүгүртүүнү өнүктүрүү.",
      ...
      },
      {
        ...
        image:
          "https://images.unsplash.com/photo-1603351820248-eb5d68f64be0?q=80&w=1080&auto=format&fit=crop",
        description:
          "U-17, U-19, U-21 өспүрүмдөр жана жаштар курама командаларын алдыңкы методикалар боюнча даярдоо.",
        programs: [
          "Жеке техника",
      ...
      },
      {
        ...
        image:
          "https://images.unsplash.com/photo-1572594505398-97a384b34ec8?q=80&w=1080&auto=format&fit=crop",
        description:
          "Спорттук сүзүү. Бардык стилдерде техниканы өркүндөтүү жана ылдамдык туруктуулугун өнүктүрүү.",
        programs: [
          "Кроль жана баттерфляй",
          "Брасс жана чалкалап сүзүү",
          "Старттар жана бурулуштар",
        ],
        athletesCount: "60",
      },
    ],
      ...
      items: [
        {
          num: "01",
          title: "КУРАК",
          desc: "Спорттун түрүнө жараша 12 жаштан 23 жашка чейин.",
        },
        {
          num: "02",
          title: "ДЕН СООЛУК",
          desc: "Толук медициналык кароодон өтүү жана спорттук диспансердин уруксаты.",
        },
        {
          num: "03",
          title: "БАЗА",
          desc: "Спорттук разряддын болушу же тастыкталган жыйынтыктар.",
        },
        {
          num: "04",
          title: "ГРАФИК",
          desc: "Аптасына 6 күн эки маал машыгууга даяр болуу.",
        },
      ],
    },
  },
              ...
              <div className="lg:col-span-5 flex flex-col justify-center order-2 lg:order-1 lg:pr-8">
                ...
                <div className="space-y-4 mb-8">
                  ...
                  {sport.programs.map((program, idx) => (
                    <div
                      key={idx}
                      className="flex items-center gap-4 border-b border-neutral-100 pb-3"
                    >
                      <div className="w-1.5 h-1.5 bg-[#FFCD00]"></div>
                      <span className="text-neutral-800 font-bold uppercase text-sm tracking-wide">
                        {program}
                      </span>
                    </div>
                  ))}
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div>
              <h2 className="text-5xl md:text-6xl font-black uppercase tracking-tighter mb-8 leading-[0.9]">
                {t.reqs.title1} <br />
                <span className="text-[#E31837]">{t.reqs.title2}</span>
              </h2>
            ...
            <div className="grid sm:grid-cols-2 gap-x-8 gap-y-12">
              {t.reqs.items.map((req, i) => (
                <div key={i} className="border-t border-neutral-800 pt-6">
                  <div className="text-3xl font-black text-[#FFCD00] mb-4">
                    {req.num}
                  </div>
