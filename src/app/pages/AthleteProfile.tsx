...
export function AthleteProfile() {
  ...
  const athlete = athletes.find((a) => a.id === idNum) ||
    athletes[0] || {
      id: 0,
      name: "",
      sport: "",
      ...
      bio: "",
      achievements: [],
      stats: { worldRank: 0, matches: 0, wins: 0, winRate: "—" },
    };
  return (
    <div className="bg-neutral-50 min-h-screen">
      ...
      <div className="relative h-[400px] lg:h-[500px] w-full bg-neutral-950">
        ...
        <div className="absolute top-8 left-4 sm:left-6 lg:left-12 z-20">
          <Link
            to="/athletes"
            className="inline-flex items-center gap-2 text-white/70 hover:text-white transition-colors text-sm font-bold uppercase tracking-widest"
          >
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-neutral-200 overflow-hidden flex flex-col lg:flex-row">
          ...
          <div className="lg:w-2/3 p-8 sm:p-12 bg-white">
            <h2 className="text-2xl font-black text-neutral-900 uppercase tracking-tight mb-6 flex items-center gap-3">
              <span className="w-8 h-1 bg-[#D50000] inline-block"></span>{" "}
              Биография
            </h2>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
              <div className="bg-neutral-50 p-6 rounded-xl border border-neutral-100 text-center">
                <div className="text-4xl font-black text-[#D50000] mb-2">
                  {athlete.stats.worldRank}
                </div>
            ...
            <h2 className="text-2xl font-black text-neutral-900 uppercase tracking-tight mb-8 flex items-center gap-3">
              <span className="w-8 h-1 bg-[#FFD700] inline-block"></span>{" "}
              Главные достижения
            </h2>
            ...
            <div className="space-y-4">
              {athlete.achievements.map((ach, i) => (
                <div
                  key={i}
                  className="flex items-center gap-6 p-4 rounded-lg border border-neutral-100 hover:bg-neutral-50 transition-colors group"
                >
                  <div
                    className={`w-12 h-12 rounded-full flex items-center justify-center flex-shrink-0 ${
                      ach.type === "gold"
                        ? "bg-[#FFD700]/20 text-yellow-600"
                        : ach.type === "silver"
                  ...
                  <div className="flex-1">
                    <h4 className="text-lg font-bold text-neutral-900 group-hover:text-[#D50000] transition-colors">
                      {ach.event}
                    </h4>
