...
const pageTranslations = {
  ru: {
    ...
    categories: ["Все", "Официально", "Борьба", "Футбол", "Легкая атлетика", "Инфраструктура"],
    mainNewsTag: "Главное",
    readMore: "Читать",
    ...
    news: [
      ...
      },
      {
        ...
        excerpt: "На отборочных соревнованиях молодые легкоатлеты побили рекорды страны в беге на 800 и 1500 метров.",
        featured: false
      },
      {
        id: 5,
        ...
        excerpt: "Молодежная сборная по баскетболу одержала уверенную победу в финале регионального чемпионата.",
        featured: false
      },
      {
        id: 6,
        ...
        category: "Официально",
        image: "https://images.unsplash.com/photo-1517466787929-bc90951d0974?q=80&w=1080&auto=format&fit=crop",
        excerpt: "Центр и Национальный олимпийский комитет договорились о расширенной программе подготовки к Играм 2028.",
        featured: false
      }
    ]
  },
  ky: {
    ...
    categories: ["Баары", "Расмий", "Күрөш", "Футбол", "Жеңил атлетика", "Инфраструктура"],
    mainNewsTag: "Башкы",
    readMore: "Окуу",
    ...
    news: [
      {
        ...
        category: "Күрөш",
        image: "https://images.unsplash.com/photo-1576149146095-caa19d4de102?q=80&w=1080&auto=format&fit=crop",
        excerpt: "Кыргызстандын эркин күрөш боюнча жаштар курамасы Азия чемпионатында көрүнүктүү натыйжаларды көрсөтүп, чыңалуу таймаштарда 3 алтын жана 2 күмүш медаль жеңип алды.",
        featured: true
      },
      {
        id: 2,
        ...
        category: "Инфраструктура",
        image: "https://images.unsplash.com/photo-1729048229977-fa74f7a330af?q=80&w=1080&auto=format&fit=crop",
        excerpt: "Олимпиадалык резервди даярдоо үчүн эң жаңы жабдуулар менен заманбап машыгуу комплексинин салтанаттуу ачылышы болду.",
        featured: true
      },
      {
        id: 3,
        ...
        category: "Футбол",
        image: "https://images.unsplash.com/photo-1603351820248-eb5d68f64be0?q=80&w=1080&auto=format&fit=crop",
        excerpt: "Команда алдыдагы турнирге даярдануу алкагында интенсивдүү машыгууларды жана жолдоштук беттештерди өткөрүүдө.",
        featured: false
      },
      {
        id: 4,
        ...
        image: "https://images.unsplash.com/photo-1765261473063-ec862e10ba58?q=80&w=1080&auto=format&fit=crop",
        excerpt: "Тандоо мелдештеринде жаш жеңил атлетчилер 800 жана 1500 метрге чуркоодо өлкөнүн рекорддорун жаңылашты.",
        featured: false
      },
      {
        id: 5,
        ...
        category: "Баскетбол",
        image: "https://images.unsplash.com/photo-1721339041100-ec39e6600362?q=80&w=1080&auto=format&fit=crop",
        excerpt: "Баскетбол боюнча жаштар курамасы аймактык чемпионаттын финалында ишенимдүү жеңишке жетти.",
        featured: false
      },
      {
        id: 6,
        ...
        category: "Расмий",
        image: "https://images.unsplash.com/photo-1517466787929-bc90951d0974?q=80&w=1080&auto=format&fit=crop",
        excerpt: "Борбор жана Улуттук олимпиада комитети 2028-жылкы Оюндарга даярдануунун кеңейтилген программасы боюнча макулдашты.",
        featured: false
      }
    ]
  }
      ...
      <section className="py-24 border-b border-neutral-200">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-12">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16">
            {t.news.filter(item => item.featured).map((item) => (
