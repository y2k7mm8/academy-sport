        ...
        <nav className="flex-1 py-6 px-3 space-y-1 overflow-y-auto">
          {navigation.map((item) => {
            ...
            return (
              ...
              >
                <item.icon className={`w-5 h-5 flex-shrink-0 ${isActive ? "text-white" : "text-neutral-400"}`} />
          ...
          <div className="flex items-center gap-4">
            ...
            <Link to="/profile" className="flex items-center gap-3 group cursor-pointer">
              <div className="w-8 h-8 rounded-full bg-neutral-200 overflow-hidden border border-neutral-300">
                <img src="https://images.unsplash.com/photo-1606335544053-c43609e6155d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwcm9mZXNzaW9uYWwlMjBhdGhsZXRlJTIwcG9ydHJhaXR8ZW58MXx8fHwxNzczNzQ3OTE0fDA&ixlib=rb-4.1.0&q=80&w=100" alt="Admin" className="w-full h-full object-cover" />
              </div>
              <div className="hidden sm:block text-left">
                <div className="text-sm font-bold text-neutral-900 leading-none mb-1">Admin User</div>
                <div className="text-xs text-neutral-500 leading-none">System Admin</div>
              </div>
            </Link>
          </div>
        </header>
