...
export function Header() {
  ...
  const navigation = [
    ...
    { path: '/athletes', label: language === 'ru' ? 'СПОРТСМЕНЫ' : 'СПОРТЧУЛАР' },
          ...
          <div className="flex justify-between items-center h-24">
            ...
            <div className="hidden lg:flex items-center space-x-6 h-full">
              ...
              <div className="flex items-center gap-4 border-l border-neutral-200 pl-6 ml-2">
                <LanguageSwitcher />
                <Link to="/admin" className="hidden xl:flex bg-[#D50000] text-white px-5 py-2.5 text-xs font-bold uppercase tracking-widest hover:bg-red-700 transition-colors shadow-sm items-center gap-2">
